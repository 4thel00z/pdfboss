...
Not yet supported (they error or degrade gracefully, and are on the roadmap): the JBIG2 features listed above · the unpainted faces listed above · `/SMask` transfer functions.
