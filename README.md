...
Not yet supported (they error or degrade gracefully, and are on the roadmap): shadings and tiling patterns · the JBIG2 features listed above · the unpainted faces listed above · soft masks and the non-separable blend modes (Hue, Saturation, Color, Luminosity).
