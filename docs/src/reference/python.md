...
| `Span` | One styled text span: text, position, bbox, ascent/descent, font identity, bold/italic/monospace/serif, underline/strikethrough/highlight, rise, vertical, invisible, color |
